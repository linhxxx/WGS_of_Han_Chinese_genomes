...
typedef struct control
	...
	int			gappedAllBounds;// (I) true  => bound gapped alignments by *all*
								...
								//              .. the score threshold
	int			mirror;			// (I) true  => each HSP or seed hit is output
...
//иии but how are they scored?
	...
	u8			dynamicMasking;	//     mask any position in target hit this many
								//     .. times;  zero or negative indicates no
								//     .. masking
	...
	void*		outputInfo;		//     additional information for the paritular
