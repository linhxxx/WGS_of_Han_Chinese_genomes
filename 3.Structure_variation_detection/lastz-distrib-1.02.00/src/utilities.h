...
int    string_to_int2         (const char* s, int byThousands);
...
char*  reverse_of_string      (char* s, int len);
char*  copy_reverse_of_string (char* s, int len);
void   strncpy_reverse        (char* d, char* s, int len);
char*  commatize              (const int64 v);
char*  unitize                (const int64 v);
