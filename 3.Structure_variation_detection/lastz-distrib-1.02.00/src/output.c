	...
	switch (outputFormat)
		...
		case fmtGfaNoScore:
			print_gfa_job_header
			   (currParams->outputFile,
			    progName, currParams->seq1->fileName, currParams->seq2->fileName);
			break;
		case fmtLav:
		case fmtLavComment:
		case fmtLavScore:
		...
		case fmtLavInfScores:
			print_lav_job_header
			   (currParams->outputFile, progName,
		...
		case fmtAxtComment:
			print_axt_job_header
			   (currParams->outputFile, progName, currParams->args,
		        currParams->scoring,
